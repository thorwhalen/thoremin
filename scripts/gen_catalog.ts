...
const CATEGORIES: Array<{ name: string; blurb: string; types: string[] }> = [
  ...
  { name: 'Synthesis & generation', blurb: 'Make sound — direct synthesis, steered AI music, or an external MIDI instrument.', types: ['webaudio-synth', 'lyria', 'midi-out', 'song-player'] },
